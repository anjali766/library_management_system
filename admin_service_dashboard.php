...
<div class="container">
<div class="innerdiv">
<div class="row"><img class="imglogo" src="vecteezy_library-logo-template-design-vector_.jpg"/></div>
 ...
 <div class="rightinnerdiv">   
            ...
            foreach($recordset as $row){
               ...
               "<td>$row[0]</td>";
                ...
                $table.="<td>$row[2]</td>";
                $table.="<td>$row[4]</td>";
                $table.="<td><a href='deleteuser.php?useriddelete=$row[0]'><button type='button' class='btn btn-primary'>Delete</button></td>";
                $table.="</tr>";
            }
            $table.="</table>";
